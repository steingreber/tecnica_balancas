  ...
  <TR vAlign=center align=middle>
    <TD><IMG height=27 alt="PageMaster Login" src="images/mc-tab-login.gif" width=300 border=0><BR>
      <TABLE cellSpacing=0 cellPadding=0 width=300 bgColor=#dcdfe1 border=0>
        <TBODY>
        <TR vAlign=center>
          <TD width=7 height=3><IMG height=3 
            src="images/background-tl.gif" width=7></TD>
          <TD width=286 background="images/background-t.gif" & vbCrLf          height=3><IMG height=3 src="images/background-t.gif" width=286></TD>
