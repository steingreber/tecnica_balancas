...
<html>
<head>
<title>EMPRESA - PageMaster 2.0</title>
...
If Trim(sValor) = "" Then
   SQL = "Select [A00ID], [A01END], [A02FONE], [A03CEP], [A04CIDADE] From [EMPRESA] Order By [A00ID] Desc"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [EMPRESA] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [EMPRESA] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
End If
...
<table cellpadding=0 cellspacing=0 width="85%" align=center>
    <tr>
          <form name="frmBusca" method="post" action=pm_EMPRESA.asp>
        <td width="853" height="34" align="center" colspan="3" class="tabelatitulo">
               <p><select name="q" size=1 class="ud_caixa">
               <option selected value="[A01END]">ENDEREÇO</option>
               <option selected value="[A02FONE]">FONE</option>
               <option selected value="[A03CEP]">CEP</option>
               <option selected value="[A04CIDADE]">CIDADE/UF</option>
               <option selected value="[A05TEXTO]">TEXTO</option>
               </select> 
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_EMPRESA_opt.asp?acao=1"><span class="aFonte">&lt;&lt; Novo Registro &gt;&gt;</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_EMPRESA.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_EMPRESA.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_EMPRESA.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_EMPRESA.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                        ...
                        <table align="center" cellpadding="0" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">ENDEREÇO</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">FONE</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">CEP</span></p>
                                </td>
                                <td align="center" class="tabelatitulo">
                                    <p><span class="aFonte">CIDADE/UF</span></p>
                                </td>
                            </tr>
<%
   Dim pmCorSel
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="70%" align="center">
                                        <tr>
                                            <td width="16" align="center">
                                                <p><a href="pm_EMPRESA_opt.asp?acao=2&sF=<%= rsTemp("A00ID") %>"><img src="images/botao_editar.gif" width=16 height=16 border=0></a></p>
                                            </td>
                                            <td width="16" align="center">
                                                <!-- <p><a onclick="return confirm_delete()" href=pm_EMPRESA_opt.asp?acao=3&sF=<%= rsTemp("A00ID") %>><img src="images/botao_apagar.gif" width=16 height=16 border=0></a></p> -->
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A01END") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A02FONE") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A03CEP") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A04CIDADE") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
