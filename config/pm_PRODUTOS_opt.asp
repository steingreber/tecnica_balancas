...
<TR>
       ...
       <TD><P><span class="aFontePT">FOTO GRANDE<br></span><INPUT class=ud_caixa style="WIDTH:360px" name=cp_A03FOTO type="file"></P></TD>
</TR>
<TR>
       <TD><P><span class="aFontePT">FOTO PEQUENA<br></span><INPUT class=ud_caixa style="WIDTH:360px" name=cp_A04FOTOP type="file"></P></TD>
                        </form>    
                            </table>
<% ElseIf acao = "2" Then %>
<%
...
'-----------------------------------------------
va_A04FOTOP                = Trim(objRS("A04FOTOP"))
va_A04FOTOP                = Replace(va_A04FOTOP,"<BR>", chr(13),1)
%>
                            <table align="center" border=1 cellspacing=0 width="775" bordercolordark="white" bordercolorlight="black">
...
<TR>
       ...
       <TD><P><span class="aFontePT">FOTO GRANDE - <a href="javascript:fotoZoom('<%= "fotos/" & va_A03FOTO%>')">VER AQUIVO</a></span><br><INPUT class=ud_caixa style="WIDTH:360px" name=cp_A03FOTO type="file"><BR></P>
       <INPUT type="hidden" name="hcp_A03FOTO" value="<%=va_A03FOTO%>">
</TR>
<TR>
       <TD><P><span class="aFontePT">FOTO PEQUENA - <a href="javascript:fotoZoom('<%= "fotos/" & va_A04FOTOP%>')">VER AQUIVO</a></span><br><INPUT class=ud_caixa style="WIDTH:360px" name=cp_A04FOTOP type="file"><BR></P>
       <INPUT type="hidden" name="hcp_A04FOTOP" value="<%=va_A04FOTOP%>">
                        </form>    
                            </table>
<% ElseIf acao = "3" Then %>
<%
...
'-----------------------------------------------
va_A04FOTOP                = Trim(UploadRequest.Item("cp_A04FOTOP").Item("Value"))
va_A04FOTOP                = Replace(va_A04FOTOP,chr(13),"<BR>" ,1)
...
'===============================================
If va_A04FOTOP <> "" Then
ContentType1 = UploadRequest.Item("cp_A04FOTOP").Item("ContentType")
filepathname1 = UploadRequest.Item("cp_A04FOTOP").Item("FileName")
FileName1 = Right(filepathname1, Len(filepathname1) - InStrRev(filepathname1, "\"))
Value1 = UploadRequest.Item("cp_A04FOTOP").Item("Value")
Set ScriptObject = Server.CreateObject("Scripting.FileSystemObject")
numero1 = instrrev(Request.servervariables("Path_Info"), "/")
Set MyFile1 = ScriptObject.CreateTextFile(Server.mappath("fotos") & "\" & FileName1)
...
Errou
va_A04FOTOP = FileName1
End If

   sSel = sSel & "INSERT INTO PRODUTOS(A04CATEG, A01NOME, A02DESC, A03FOTO, A04FOTOP)"
   sSel = sSel & "VALUES ('" & va_A04CATEG & "', '" & va_A01NOME & "', '" & va_A02DESC & "', '" & va_A03FOTO & "', '" & va_A04FOTOP & "')"
   Set objRS = objConect.Execute(sSel)
   response.redirect "pm_PRODUTOS.asp"
...
'***********************************************
va_A04FOTOPh                = Trim(UploadRequest.Item("hcp_A04FOTOP").Item("Value"))
va_A04FOTOPh                = Replace(va_A04FOTOPh,chr(13),"<BR>" ,1)
'***********************************************
sNot = request.querystring("sF")
'===============================================
If va_A03FOTO <> "" Then
...
va_A04FOTOP = FileName1
Else
va_A04FOTOP = va_A04FOTOPh
End If

   sSel = sSel & "UPDATE PRODUTOS SET "
   sSel = sSel & "A04CATEG = '" & va_A04CATEG & "', A01NOME = '" & va_A01NOME & "', A02DESC = '" & va_A02DESC & "', A03FOTO = '" & va_A03FOTO & "', A04FOTOP = '" & va_A04FOTOP & "' "
