...
<html>
<head>
<title>PRODUTOS - PageMaster 2.0</title>
...
If Trim(sValor) = "" Then
   SQL = "Select [A00ID], [A01NOME], [A03FOTO], [A04CATEG] From [PRODUTOS] Order By [A00ID] Desc"
Else
   If Trim(sTipo) = "Like" Then
   SQL = "Select * From [PRODUTOS] Where " & sCampo & " " & sTipo & "'%" & sValor & "%'"
   Else
   SQL = "Select * From [PRODUTOS] Where " & sCampo & " " & sTipo & "'" & sValor & "'"
   End If
End If
...
<table cellpadding=0 cellspacing=0 width="85%" align=center>
    <tr>
          <form name="frmBusca" method="post" action=pm_PRODUTOS.asp>
        <td width="853" height="34" align="center" colspan="3" class="tabelatitulo">
               <p><select name="q" size=1 class="ud_caixa">
               <option selected value="[A04CATEG]">CATEGORIA</option>
               <option selected value="[A01NOME]">NOME</option>
               <option selected value="[A02DESC]">DESCRIÇÃO</option>
               <option selected value="[A03FOTO]">FOTO</option>
               </select> 
    ...
    <tr>
        <td width=494 height=20 align="center" class="tabelatitulo">
            <p><a href="pm_PRODUTOS_opt.asp?acao=1"><span class="aFonte">&lt;&lt; Novo Registro &gt;&gt;</span></a></p>
        </td>
...
<span class="aFonte"><B>
<%
  Response.Write "<A HREF=""pm_PRODUTOS.asp?Page=1""><img src='images/p2.gif' alt=Primeiro width=16 height=16 border=0> </A>"
if Current_Page > 1 then
  Response.Write "<A HREF=""pm_PRODUTOS.asp?Page=" & (Current_Page - 1) & """><img src='images/p1.gif' alt=Anterior width=16 height=16 border=0> </A> " & vbCrLfelse
  Response.Write ""
end if
if Current_Page < Page_Count then
  Response.Write "<A HREF=""pm_PRODUTOS.asp?Page=" & (Current_Page + 1) & """><img src='images/p3.gif' alt=Próximo width=16 height=16 border=0> </A>"
else
  Response.Write ""
end if
  Response.Write "<A HREF=""pm_PRODUTOS.asp?Page=" & Page_Count & """><img src='images/p4.gif' alt=Último width=16 height=16 border=0>   </A>"
%>
</B></FONT></td>
    </tr>
    <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="70%" align="center">
                                        <tr>
                                            <td width="16" align="center">
                                                <p><a href="pm_PRODUTOS_opt.asp?acao=2&sF=<%= rsTemp("A00ID") %>"><img src="images/botao_editar.gif" width=16 height=16 border=0></a></p>
                                            </td>
                                            <td width="16" align="center">
                                                <p><a onclick="return confirm_delete()" href=pm_PRODUTOS_opt.asp?acao=3&sF=<%= rsTemp("A00ID") %>><img src="images/botao_apagar.gif" width=16 height=16 border=0></a></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A01NOME") %></font></p>
                                </td>
                                <td align="Left">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A03FOTO") %></font></p>
                                </td>
                                <td align="Center">
                                    <p><font size="2" face="Trebuchet MS"><%= rsTemp("A04CATEG") %></font></p>
                                </td>
                            </tr>
<%
   rsTemp.MoveNext
